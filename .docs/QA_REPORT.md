...
- Source branch: `master`, existing private remote `https://github.com/sion-rgb/canto-suite`. This amendment is published as the private pre-release [`v0.1.0-rc4`](https://github.com/sion-rgb/canto-suite/releases/tag/v0.1.0-rc4). RC3 below is historical and does not contain this amendment.
